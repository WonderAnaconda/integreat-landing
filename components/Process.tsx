  ...
  const steps = [
    {
      number: "01",
      title: "Consultation",
      description: "We begin with a comprehensive analysis of your current systems and identify opportunities for optimization and growth.",
      image: Workflow01,
      delay: 0
    },
    {
      ...
      description: "Our team implements custom solutions tailored to your specific needs, ensuring seamless integration with existing workflows.",
      image: Workflow02,
      delay: 200
    },
    {
      ...
      description: "We launch your new system and provide ongoing support to ensure maximum performance and continuous improvement.",
      image: Workflow03,
      delay: 400
    }
  ];
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl text-center pb-12 md:pb-20">
            ...
            <p
              ...
              data-aos-delay={200}
            >
              Our proven three-step process ensures your success from consultation to launch
            </p>
          </div>
